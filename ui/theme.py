...
STR = {
    "en": {
        ...
        "loading": "Loading data…", "ready": "Ready", "next_bar": "next bar in", "stale_cache": "stale cache — no live source reachable", "category": "Category", "all": "All",
    ...
    "fa": {
        ...
        "loading": "در حال دریافت داده…", "ready": "آماده", "next_bar": "کندل بعدی تا", "stale_cache": "کش قدیمی — منبع زنده در دسترس نیست", "category": "دسته", "all": "همه",
