...
STR = {
    "en": {
        ...
        "nav_intelligence": "🧠 Strategy Intelligence",
        "intelligence_sub": "AI automatically selects the best strategy for each chart & timeframe based on market regime, timeframe match, and proven performance",
    ...
    "fa": {
        ...
        "nav_tv": "چارت پیشرفته",
        "nav_intelligence": "🧠 هوش استراتژی",
        "intelligence_sub": "هوش مصنوعی بهترین استراتژی را برای هر چارت و تایم‌فریم بر اساس رژیم بازار، تطابق تایم‌فریم و عملکرد اثبات‌شده انتخاب می‌کند",
